...
namespace SalariesDll
{
	...
	public class Utilisateur
	{
		...
		private int _nombreEchecsConsecutifs = 0;
		...
		public ConnectionResult Connecter(string motDePasse)
		{
			...
			if (!this.CompteBloque && this.MotDePasse == motDePasse)
			{
			...
			if (this.NombreEchecsConsecutifs >2)
			{
		...
		public bool IsConnectionBloque()
		{
			string motDePasse=_motDePasse;
