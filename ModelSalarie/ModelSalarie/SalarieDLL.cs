...
*/
        ...
        protected virtual void OnChangementSalary_EventHandler(object sender, ChangeSalaireEventArgs e)
        {
            if (ChangementSalary_EventHandler != null)
            {
                ChangementSalary_EventHandler(sender, e);
            }
        ...
        public double SalaireBrut
        {
            ...
            set
            {
                OnChangementSalary_EventHandler(this, new ChangeSalaireEventArgs(this._salaireBrut, value));
                _salaireBrut = value;
            }
        }
        ...
        // Un délégué est un intermédiaire qui permet de faire passer la référence de la méthode
        //à invoquer dans un contexte spécifique(d'où les arguments). Permet d'utiliser le même
        //événement pour plusieurs interfaces.
        public event EventHandler<ChangeSalaireEventArgs> ChangementSalary_EventHandler;

      
    }
    public class ChangeSalaireEventArgs : EventArgs

    {
       

        double _ancienSalaire;
        double _tauxAugm;
       


        /// <summary>
        /// Création d'un événement de type délégué.
        /// </summary>
        /// <param name="ancienSalaire"></param>
        /// <param name="tauxAugm"></param>
        public ChangeSalaireEventArgs(double ancienSalaire, double tauxAugm)
        {
